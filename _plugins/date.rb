...
module Jekyll
  ...
  class Document
      ...
      def to_liquid
        ...
        # Utils.deep_merge_hashes(collapse_document(super_to_liquid), liquid_date_attributes)
        super_to_liquid.merge(liquid_date_attributes)
      end
  end
  ...
  class Page
    ...
    def to_liquid
      # super_to_liquid.deep_merge(liquid_date_attributes)
      # Utils.deep_merge_hashes(super_to_liquid, liquid_date_attributes)
      super_to_liquid.merge(liquid_date_attributes)
    end
  end
end
